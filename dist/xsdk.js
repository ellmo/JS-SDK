...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sdkType = __webpack_require__(300);

	var _sdkType2 = _interopRequireDefault(_sdkType);

	var _xui = __webpack_require__(301);

	var _xui2 = _interopRequireDefault(_xui);

	var _dataStorage = __webpack_require__(303);
	...
	var _lang = __webpack_require__(307);
	...
	function _login(userId, authorize) {
	  (0, _lang.stringChect)(userId);
	  (0, _lang.stringChect)(authorize);
	...
	function _getXUI() {
	  return _xui2.default;
	}

	function _getDataStorage() {
	  return _dataStorage2.default;
	}

	function XSDK(type, option) {
	  (0, _lang.stringChect)(type);

	  type === _sdkType2.default.WEBSOCKET ? (0, _lang.objectChect)(option) : null;

	  if (this instanceof XSDK) {
	    if (sdkInstance[type] === undefined) {
	      switch (type) {
	        case _sdkType2.default.WIFI:
	          break;
	        case _sdkType2.default.BLUETOOTH:
	          break;
	        case _sdkType2.default.WEBSOCKET:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sdkEvent = __webpack_require__(302);

	var _sdkEvent2 = _interopRequireDefault(_sdkEvent);
	...
	function _on(event) {
	  switch (event) {
	    case _sdkEvent2.default.UIBACK:
	      break;
	    default:
...
/***/ function(module, exports) {
	...
	SDKEvent.STATUSCHANGE = 'statuschange'; // SDK和设备状态，即蓝牙和WIFI状态改变事件
	SDKEvent.STARTSCAN = 'startscan'; // 开始扫描设备
	SDKEvent.CANCELSCAN = 'cancelscan'; // 取消扫描设备
	SDKEvent.DEVICESREADY = 'devicesready'; // 添加或扫描设备完成
	SDKEvent.ADDDEVICES = 'adddevices'; // 添加设备
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sdkState = __webpack_require__(305);

	var _sdkState2 = _interopRequireDefault(_sdkState);
	...
	function _initSocketIO(sdk, option) {
	  ...
	  _socket.on('connect', function () {
	    sdk._status = _sdkState2.default.CONNECT;
	  }).on('reconnect', function () {
	    sdk._status = _sdkState2.default.CONNECT;
	  }).on('disconnect', function () {
	    sdk._status = _sdkState2.default.DISCONNECT;
	  }).on('reconnect_attempt', function () {
	    sdk._status = _sdkState2.default.CONNECTTING;
	  }).on('reconnecting', function () {
	    sdk._status = _sdkState2.default.CONNECTTING;
	  }).on('reconnect_error', function (error) {
	    _fire(sdk, _sdkEvent2.default.ERROR, error);
	  }).on('reconnect_failed', function () {
	    _fire(sdk, _sdkEvent2.default.ERROR, {});
	...
	function _initState(sdk) {
	  Object.defineProperty(sdk, '_status', {
	    set: function set(status) {
	      if (this.status !== status) {
	        _fire(sdk, _sdkEvent2.default.STATUSCHANGE, status);
	      } else {
	        return;
	      }

	      if (status === _sdkState2.default.CONNECT && !sdk._isReady) {
	        _fire(sdk, _sdkEvent2.default.READY);
	  ...
	  sdk.status = _sdkState2.default.DISCONNECT;
	}

	function _fire(sdk, event, params) {
	  switch (event) {
	    case _sdkEvent2.default.READY:
	      if (sdk._callback[_sdkEvent2.default.READY]) {
	        sdk._callback[_sdkEvent2.default.READY]();
	      }
	      break;
	    case _sdkEvent2.default.DEVICESREADY:
	      if (sdk._callback[_sdkEvent2.default.DEVICESREADY]) {
	        sdk._callback[_sdkEvent2.default.DEVICESREADY](params);
	      }
	      break;
	    case _sdkEvent2.default.STATUSCHANGE:
	      if (sdk._callback[_sdkEvent2.default.STATUSCHANGE]) {
	        sdk._callback[_sdkEvent2.default.STATUSCHANGE](params);
	      }
	      break;
	    case _sdkEvent2.default.ERROR:
	      if (sdk._callback[_sdkEvent2.default.ERROR]) {
	        sdk._callback[_sdkEvent2.default.ERROR](params);
	      }
	      break;
	    default:
	      break;
	...
	function _on(event, callback) {
	  (0, _lang.stringChect)(event);
	  (0, _lang.functionChect)(callback);

	  switch (event) {
	    case _sdkEvent2.default.READY:
	      this._callback[_sdkEvent2.default.READY] = callback;
	      break;
	    case _sdkEvent2.default.DEVICESREADY:
	      this._callback[_sdkEvent2.default.DEVICESREADY] = callback;
	      break;
	    case _sdkEvent2.default.STATUSCHANGE:
	      this._callback[_sdkEvent2.default.STATUSCHANGE] = callback;
	      break;
	    case _sdkEvent2.default.ERROR:
	      this._callback[_sdkEvent2.default.ERROR] = callback;
	      break;
	    default:
	      console.warn('event: ' + event + 'is not support');
	      break;
	...
	function _emit(event, params) {
	  (0, _lang.stringChect)(event);
	  (0, _lang.objectOrArrayChect)(params);

	  switch (event) {
	    case _sdkEvent2.default.DESTORY:
	      this._socket = null;
	      break;
	    case _sdkEvent2.default.ADDDEVICES:
	...
	function _addDevices(params) {
	  ...
	  _fire(this, _sdkEvent2.default.DEVICESREADY, this.devices);
	}
	...
	function _connect() {
	  ...
	  console.log('device to be connect');
	  console.log(_sdkEvent2.default.CONNECT);
	  this._socket.emit('device.connect', params, function () {
	    console.log('fire device connect');
	    this._fire(_sdkEvent2.default.CONNECT);
	  }.bind(this));
	}
	...
	function _disconnect() {
	  ...
	  this._socket.emit('device.disconnect', params, function () {
	    this._fire(_sdkEvent2.default.DISCONNECT);
	  });
	}
	...
	function _dispatchDeviceData(devices, data) {
	  ...
	  if (device) {
	    ...
	    device._fire(_sdkEvent2.default.DATA, params);
	  }
	}
	...
	function _dispatchDeviceStatus(devices, status) {
	  ...
	  device._fire(_sdkEvent2.default.STATUSCHANGE, status.state);
	}
...
/***/ function(module, exports) {
	...
	SDKState.DISCONNECT = 0; // 默认为断开
	SDKState.CONNECTTING = 1; // 正在连接
	SDKState.CONNECT = 2; // 已连接

	exports.default = SDKState;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _on(event, fn) {
	  (0, _lang.stringChect)(event);
	  (0, _lang.functionChect)(fn);

	  switch (event) {
	    case _sdkEvent2.default.CONNECT:
	      this._callback[_sdkEvent2.default.CONNECT] = fn;
	      break;
	    case _sdkEvent2.default.DISCONNECT:
	      this._callback[_sdkEvent2.default.DISCONNECT] = fn;
	      break;
	    case _sdkEvent2.default.STATUSCHANGE:
	      this._callback[_sdkEvent2.default.STATUSCHANGE] = fn;
	      break;
	    case _sdkEvent2.default.DATA:
	      this._callback[_sdkEvent2.default.DATA] = fn;
	      break;
	    case _sdkEvent2.default.ERROR:
	      this._callback[_sdkEvent2.default.ERROR] = fn;
	      break;
	    default:
	      console.warn('event: ' + event + 'is not support');
	      break;
	...
	function _emit(event, data) {
	  (0, _lang.stringChect)(event);
	  event === _sdkEvent2.default.SENDDATA ? (0, _lang.stringChect)(data) : null;
	  ...
	  switch (event) {
	    ...
	    case _sdkEvent2.default.DISCONNECT:
	      this._disconnect();
	      break;
	    case _sdkEvent2.default.SENDDATA:
	      this._sendData(data);
	      break;
	    default:
	      console.warn('event: ' + event + 'is not support');
	...
	function _fire(event, data) {
	  switch (event) {
	    case _sdkEvent2.default.CONNECT:
	      this._callback[_sdkEvent2.default.CONNECT]();
	      break;
	    case _sdkEvent2.default.DISCONNECT:
	      this._callback[_sdkEvent2.default.DISCONNECT]();
	      break;
	    case _sdkEvent2.default.DATA:
	      this._callback[_sdkEvent2.default.DATA](data);
	      break;
	    case _sdkEvent2.default.STATUSCHANGE:
	      this._callback[_sdkEvent2.default.STATUSCHANGE](data);
	      break;
	    case _sdkEvent2.default.ERROR:
	      this._callback[_sdkEvent2.default.ERROR](data);
	      break;
	    default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.objectChect = objectChect;
	exports.functionChect = functionChect;
	exports.stringChect = stringChect;
	exports.objectOrArrayChect = objectOrArrayChect;
	...
	function objectChect(obj) {
	  if (!_Lang2.default.isObject(obj)) {
	    throw new TypeError('must be Object');
	  }
	}

	function functionChect(obj) {
	  if (!_Lang2.default.isFunction(obj)) {
	    throw new TypeError('must be function');
	  }
	}

	function stringChect(obj) {
	  if (!_Lang2.default.isString(obj)) {
	    throw new TypeError('must be string');
	  }
	}

	function objectOrArrayChect(obj) {
	  if (!_Lang2.default.isObject(obj) && !_Lang2.default.isArray(obj)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  'castArray': __webpack_require__(309),
	  'clone': __webpack_require__(311),
	  'cloneDeep': __webpack_require__(408),
	  'cloneDeepWith': __webpack_require__(409),
	  'cloneWith': __webpack_require__(410),
	  'eq': __webpack_require__(318),
	  'gt': __webpack_require__(411),
	  'gte': __webpack_require__(416),
	  'isArguments': __webpack_require__(364),
	  'isArray': __webpack_require__(310),
	  'isArrayBuffer': __webpack_require__(417),
	  'isArrayLike': __webpack_require__(366),
	  'isArrayLikeObject': __webpack_require__(365),
	  'isBoolean': __webpack_require__(418),
	  'isBuffer': __webpack_require__(405),
	  'isDate': __webpack_require__(419),
	  'isElement': __webpack_require__(420),
	  'isEmpty': __webpack_require__(422),
	  'isEqual': __webpack_require__(423),
	  'isEqualWith': __webpack_require__(434),
	  'isError': __webpack_require__(435),
	  'isFinite': __webpack_require__(436),
	  'isFunction': __webpack_require__(334),
	  'isInteger': __webpack_require__(437),
	  'isLength': __webpack_require__(369),
	  'isMap': __webpack_require__(440),
	  'isMatch': __webpack_require__(441),
	  'isMatchWith': __webpack_require__(445),
	  'isNaN': __webpack_require__(446),
	  'isNative': __webpack_require__(448),
	  'isNil': __webpack_require__(450),
	  'isNull': __webpack_require__(451),
	  'isNumber': __webpack_require__(447),
	  'isObject': __webpack_require__(335),
	  'isObjectLike': __webpack_require__(370),
	  'isPlainObject': __webpack_require__(421),
	  'isRegExp': __webpack_require__(452),
	  'isSafeInteger': __webpack_require__(453),
	  'isSet': __webpack_require__(454),
	  'isString': __webpack_require__(371),
	  'isSymbol': __webpack_require__(415),
	  'isTypedArray': __webpack_require__(433),
	  'isUndefined': __webpack_require__(455),
	  'isWeakMap': __webpack_require__(456),
	  'isWeakSet': __webpack_require__(457),
	  'lt': __webpack_require__(458),
	  'lte': __webpack_require__(460),
	  'toArray': __webpack_require__(461),
	  'toFinite': __webpack_require__(439),
	  'toInteger': __webpack_require__(438),
	  'toLength': __webpack_require__(467),
	  'toNumber': __webpack_require__(414),
	  'toPlainObject': __webpack_require__(469),
	  'toSafeInteger': __webpack_require__(473),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseClone = __webpack_require__(312);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stack = __webpack_require__(313),
	    arrayEach = __webpack_require__(354),
	    assignValue = __webpack_require__(355),
	    baseAssign = __webpack_require__(356),
	    cloneBuffer = __webpack_require__(374),
	    copyArray = __webpack_require__(375),
	    copySymbols = __webpack_require__(376),
	    getAllKeys = __webpack_require__(379),
	    getTag = __webpack_require__(382),
	    initCloneArray = __webpack_require__(387),
	    initCloneByTag = __webpack_require__(388),
	    initCloneObject = __webpack_require__(403),
	    isArray = __webpack_require__(310),
	    isBuffer = __webpack_require__(405),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListCache = __webpack_require__(314),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var nativeCreate = __webpack_require__(331);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isFunction = __webpack_require__(334),
	    ...
	    isObject = __webpack_require__(335),
	    toSource = __webpack_require__(341);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var checkGlobal = __webpack_require__(340);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getMapData = __webpack_require__(349);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var copyObject = __webpack_require__(357),
	    keys = __webpack_require__(358);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseHas = __webpack_require__(359),
	    baseKeys = __webpack_require__(361),
	    indexKeys = __webpack_require__(362),
	    isArrayLike = __webpack_require__(366),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(360);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArrayLikeObject = __webpack_require__(365);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArrayLike = __webpack_require__(366),
	    isObjectLike = __webpack_require__(370);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getLength = __webpack_require__(367),
	    isFunction = __webpack_require__(334),
	    isLength = __webpack_require__(369);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var stubArray = __webpack_require__(378);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseGetAllKeys = __webpack_require__(380),
	    getSymbols = __webpack_require__(377),
	    keys = __webpack_require__(358);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayPush = __webpack_require__(381),
	    isArray = __webpack_require__(310);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataView = __webpack_require__(383),
	    Map = __webpack_require__(347),
	    Promise = __webpack_require__(384),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cloneArrayBuffer = __webpack_require__(389),
	    ...
	    cloneTypedArray = __webpack_require__(402);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Uint8Array = __webpack_require__(390);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addMapEntry = __webpack_require__(393),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Symbol = __webpack_require__(401);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseCreate = __webpack_require__(404),
	    getPrototype = __webpack_require__(360),
	    isPrototype = __webpack_require__(373);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module) {var root = __webpack_require__(339),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseGt = __webpack_require__(412),
	    createRelationalOperation = __webpack_require__(413);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObjectLike = __webpack_require__(370);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createRelationalOperation = __webpack_require__(413);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getTag = __webpack_require__(382),
	    isArguments = __webpack_require__(364),
	    isArray = __webpack_require__(310),
	    isArrayLike = __webpack_require__(366),
	    isBuffer = __webpack_require__(405),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Symbol = __webpack_require__(401),
	    Uint8Array = __webpack_require__(390),
	    equalArrays = __webpack_require__(426),
	    mapToArray = __webpack_require__(395),
	    setToArray = __webpack_require__(399);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIsMatch = __webpack_require__(442),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isStrictComparable = __webpack_require__(444),
	    keys = __webpack_require__(358);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isNumber = __webpack_require__(447);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIsNative = __webpack_require__(333),
	    isMaskable = __webpack_require__(449);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isInteger = __webpack_require__(437);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseLt = __webpack_require__(459),
	    createRelationalOperation = __webpack_require__(413);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Symbol = __webpack_require__(401),
	    ...
	    isArrayLike = __webpack_require__(366),
	    isString = __webpack_require__(371),
	    iteratorToArray = __webpack_require__(462),
	    mapToArray = __webpack_require__(395),
	    setToArray = __webpack_require__(399),
	    stringToArray = __webpack_require__(463),
	    values = __webpack_require__(464);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseValues = __webpack_require__(465),
	    keys = __webpack_require__(358);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseClamp = __webpack_require__(468),
	    toInteger = __webpack_require__(438);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseKeysIn = __webpack_require__(471),
	    indexKeys = __webpack_require__(362),
	    isIndex = __webpack_require__(372),
	    isPrototype = __webpack_require__(373);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflect = __webpack_require__(472),
	    iteratorToArray = __webpack_require__(462);
