...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sdkEvent = __webpack_require__(1);

	var _sdkEvent2 = _interopRequireDefault(_sdkEvent);

	var _sdkType = __webpack_require__(2);
	...
	var _dataStorage = __webpack_require__(6);
	...
	function _login(userId, authorize) {
	  ...
	  if (!_lodash2.default.isString(userId)) {
	    throw new Error(userId + ' must be String type');
	  }

	  if (!_lodash2.default.isString(authorize)) {
	...
	function _emit(event) {
	  ...
	  switch (event) {
	    case _sdkEvent2.default.STARTSCAN:
	      break;
	    case _sdkEvent2.default.CANCELSCAN:
	      break;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _get(key, table) {
	  ...
	  if (table === undefined) {
	    // 在默认表中获取数据
	      ...
	      if (!_lodash2.default.isString(table)) {
	...
	function _insert(data, collection) {
	  ...
	  if (!_lodash2.default.isString(collection)) {
	...
	function _find(collection, condition) {
	  if (!_lodash2.default.isObject(condition)) {
