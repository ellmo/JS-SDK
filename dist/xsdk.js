...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackMissingModule() { throw new Error("Cannot find module \"min\""); }());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _xui = __webpack_require__(3);
	...
	function XSDK(type, option) {
	  ...
	  if (type === _enum.SDKType.WEBSOCKET) {
	    // 发送数据时，数据项不能为空
	    if (!(0, _lang.isPlainObject)(option) || !(0, _lang.isString)(option.type) || !(0, _lang.isString)(option.host) || !(0, _lang.isString)(option.userid)) {
	      throw new TypeError('error params');
	    }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _socket2 = __webpack_require__(6);

	var _socket3 = _interopRequireDefault(_socket2);

	var _enum = __webpack_require__(2);

	var _device = __webpack_require__(56);
	...
	function _fire(sdk, event, params) {
	  switch (event) {
	    case _enum.SDKEvent.READY:
	      if (sdk._callback[_enum.SDKEvent.READY]) {
	        sdk._callback[_enum.SDKEvent.READY]();
	      }
	      break;
	    case _enum.SDKEvent.DEVICESREADY:
	      if (sdk._callback[_enum.SDKEvent.DEVICESREADY]) {
	        sdk._callback[_enum.SDKEvent.DEVICESREADY](params);
	      }
	      break;
	    case _enum.SDKEvent.STATUSCHANGE:
	      if (sdk._callback[_enum.SDKEvent.STATUSCHANGE]) {
	        sdk._callback[_enum.SDKEvent.STATUSCHANGE](params);
	      }
	      break;
	    case _enum.SDKEvent.ERROR:
	      if (sdk._callback[_enum.SDKEvent.ERROR]) {
	        sdk._callback[_enum.SDKEvent.ERROR](params);
	      }
	      break;
	    default:
	      break;
	...
	function _on(event, callback) {
	  ...
	  switch (event) {
	    ...
	    case _enum.SDKEvent.STATUSCHANGE:
	      ...
	      break;
	    case _enum.SDKEvent.ERROR:
	      this._callback[_enum.SDKEvent.ERROR] = callback;
	      break;
	    default:
	      console.warn('event: ' + event + 'is not support');
	      break;
	...
	function _emit(event, params) {
	  ...
	  if (event === _enum.SDKEvent.ADDDEVICES) {
	    // 添加设备时，数据项不能为空
	    if ((0, _lang.isArray)(params)) {
	      params.forEach(function (item) {
	        if (!(0, _lang.isPlainObject)(item)) {
	          throw new TypeError('error params');
	        }
	      });
	    } else {
	      if (!(0, _lang.isPlainObject)(params)) {
	        throw new TypeError('error params');
	      }
	    }
	  }
	...
	function _addDevices(params) {
	  ...
	  _fire(this, _enum.SDKEvent.DEVICESREADY, this.devices);
	}
